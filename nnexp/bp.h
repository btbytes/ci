...
extern void  BP_Input_From_PSO(float *vec);
extern int   BP_Get_PSO_Dimension(void);
extern float BP_Get_Criterion(void);
extern char* BP_Get_Result_File_Name(void);
extern int   BP_Get_Target_Dimension(void);
extern void  BP_Get_Target(float *target);
#endif
